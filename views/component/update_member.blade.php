...
<article id="updatemember">
    ...
    {!! 
	    $form->options(['target'=>'requestHandler','class'=>'text-left', 'enctype' => 'multipart/form-data'])
	...
	!!}
        <div class="fields">
            ...
            <div class="field half"><input class="form-control text-white" type="email" name="email" placeholder="{{$member->memberEmail}}*"></div>
            ...
            <div class="field half"><label for="avatar">Avatar:</label><input type="file" name="avatar" required><p>pouze jpg/png/jpeg</p></div>
            ...
            <div class="field">
                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-2" name="terms"><label class="form-check-label" for="formCheck-2"><a title="vaše informace budou veřejné" href="/terms#terms">Viditelné <b style="color:#e72d2d">**</b></a></label></div>
             </div>     
        </div>
        <ul class="actions">

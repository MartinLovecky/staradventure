...
<p style="font-size:15px;line-height:22px;margin:15px 0;padding:0;color:#000">Pokud jste nám poslali požadavek na
...
<span style="text-align:center;display:block">
    <a href="{{$url}}/newpassword?action=reset&amp;id={!! $encryptedID !!}&amp;token={{$token}}#newpassword"

	...
	!!}
        <div class="fields">
            ...
            <div class="field half">
                ...
                <label class="form-check-label" for="formCheck-2"><a href="/terms#terms">Terms of Service</a></label></div>
            </div>
            <div class="field half">
                <div class="form-check">
                <input class="form-check-input" type="radio" id="formCheck-1" name="vops" required>
                <label class="form-check-label" for="formCheck-1"><a href="/vop#vop">Privacy Policy</a></label></div>
            </div>
        </div>
        <ul class="actions">

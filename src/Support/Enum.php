...
class Enum
{
    ...
    public const string REQUEST_DELETE = 'success_Account successfully deleted';
    ...
    // Danger Messages
    public const string VALIDATION_CSRF_ERROR = 'danger_CSRF validation failed';
    public const string VALIDATION_PASSWORD_REGEX = 'danger_Password must contain at least one lowercase letter, one uppercase letter, one number, and one special character (!@$%^&)';
    public const string VALIDATION_EMAIL_FORMAT = 'danger_Invalid email format (%s)';
    public const string VALIDATION_FORGOTTEN_USER = 'danger_Email (%s) does not exist in the database';
    public const string VALIDATION_REG_CHECKBOX_FAIL = 'danger_Checkbox validation failed';
    public const string VALIDATION_USER_NOT_EXIST = 'danger_User %s does not exist';
    public const string VALIDATION_USER_ALREADY_EXISTS = 'danger_User %s already exists';
    public const string VALIDATION_LEN_PASSWORD = 'danger_Password must be at least 6 characters long';
    public const string VALIDATION_PASSWORD_AGAIN = 'danger_Passwords must match';
    public const string VALIDATION_LEN_USER = 'danger_Username %s must be at least 4 characters long';
    public const string VALIDATION_ACTIVE_MEMBER = 'danger_Account is not activated';
